...
function CallRow({
  ...
  const row = /*#__PURE__*/_jsxs("div", {
    ...
    ...{
      ...
      1: {
        className: "x78zum5 x6s0dn4 x1s4dlld xjwf9q1 x13f7esw x1ypdohk x16khyan xh6dtrn x7a5moj xtedp8i xoevpu5"
      }
    }[!!hasDetail << 0],
    children: [/*#__PURE__*/_jsxs("span", {
      ...
      ...{
        className: "x3nfvp2 x6s0dn4 xl56j7k x2lah0s x6jxa94 x1v9usgg xnbbluu xvc5jky"
      },
      children: /*#__PURE__*/_jsx(Icon, {
        icon: "chevronDown",
        size: "xsm",
        color: "inherit",
        xstyle: [styles.chevronTransition, isDetailOpen && styles.chevronExpanded]
      })
    })]
  });
  if (!hasDetail) {
...
export function ChatToolCalls(props) {
  ...
  return /*#__PURE__*/_jsxs("div", {
    ...
    children: [/*#__PURE__*/_jsxs("div", {
      ...
      ...{
        className: "x78zum5 x6s0dn4 x1s4dlld xjwf9q1 x13f7esw x1ypdohk x16khyan"
      },
      children: [isExpanded ? /*#__PURE__*/_jsxs(_Fragment, {
        children: [/*#__PURE__*/_jsx("span", {
          ...
          children: t('@astryx.chatToolCalls.groupLabel', {
            count: calls.length
          })
        })]
      }) : /*#__PURE__*/_jsxs(_Fragment, {
        ...
        ...{
          className: "x3nfvp2 x6s0dn4 xl56j7k x2lah0s x6jxa94 x1v9usgg xnbbluu"
        },
        children: /*#__PURE__*/_jsx(Icon, {
          icon: "chevronDown",
          size: "xsm",
          color: "inherit",
          xstyle: [styles.chevronTransition, isExpanded && styles.chevronExpanded]
        })
      })]
    }), /*#__PURE__*/_jsx("div", {
      id: contentId,
      ...{
        0: {
          className: "xrvj5dj xihq33y xb0j27v x9kvfbb"
        },
        1: {
          className: "xrvj5dj xb0j27v x9kvfbb x1tu4anv"
        }
      }[!!isExpanded << 0],
