...
export function Citation({
  ...
  const iconNode = source.icon != null && typeof source.icon !== 'string' ? source.icon : null;
  const imageSrc = source.src ?? (typeof source.icon === 'string' ? source.icon : undefined);
  ...
  if (variant === 'number') {
    return /*#__PURE__*/_jsx(Tag, {
      ...
      ref: elementRef,
      role: noteRole,
      "aria-label": t('@astryx.citation.label', {
        number,
        title
      }),
      "data-testid": testId,
      ...
      ...mergeProps(themeProps('citation', {
        variant
      }), stylex.props(styles.number, href != null && styles.numberHover, href != null && styles.numberInteractive, xstyle), className, style),
      children: number
    });
  }
  return /*#__PURE__*/_jsxs(Tag, {
    ...
    ...mergeProps(themeProps('citation', {
      variant
    }), stylex.props(styles.label, hasIcon && styles.labelWithIcon, href != null && styles.labelHover, href != null && styles.labelInteractive, xstyle), className, style),
    children: [hasIcon && /*#__PURE__*/_jsx("span", {
      "aria-hidden": "true",
      ...{
        className: "x3nfvp2 x6s0dn4 xl56j7k x12xnipv x6b6gus xjspbzw x10xzikg x1litavf x1y0btm7 x14i3s5s xb3r6kr x2lah0s"
      },
      children: iconNode != null ? renderIconSlot(iconNode, {
        size: 'sm'
      }) : /*#__PURE__*/_jsx("img", {
        src: imageSrc,
        alt: "",
