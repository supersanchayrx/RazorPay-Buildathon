...
function pseudoIsRealBox(input, style, pseudo, baseWidth) {
...
function probeEngine() {
  ...
  input.style.cssText = 'position:fixed;top:-9999px;left:0;width:auto;min-width:0;max-width:none;' + 'padding:0;border:0;font-size:16px;box-sizing:content-box;';
 ...
 */
export function hasEditableDateSegments(isTouchPointer) {
 ...
 *   document.
 */
export function resetDateSegmentProbe() {
  cachedEngine = null;
}