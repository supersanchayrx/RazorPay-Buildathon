 ...
 */
export function usePointerDragScroll(ref, isEnabled = true) {
  useEffect(() => {
    ...
    element.addEventListener('click', onClickCapture, {
      capture: true
    });
    return () => {
      ...
      element.removeEventListener('click', onClickCapture, {
        capture: true
      });
      restoreSnap();
    };
 ...
 */
function firstRowHeight(element) {
