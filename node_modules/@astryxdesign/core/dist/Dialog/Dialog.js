...
const dynamicStyles = {
  ...
  position: (top, insetInlineStart, insetInlineEnd, bottom) => [_temp, {
    ...
    "--x-insetInlineStart": (val => typeof val === "number" ? val + "px" : val != null ? val : undefined)(insetInlineStart),
    "--x-insetInlineEnd": (val => typeof val === "number" ? val + "px" : val != null ? val : undefined)(insetInlineEnd),
    "--x-bottom": (val => typeof val === "number" ? val + "px" : val != null ? val : undefined)(bottom)
  }]
};
 ...
 * @see DialogPosition
 */
export function resolveDialogPositionOffsets(position) {
  const {
    top,
    bottom,
    start,
