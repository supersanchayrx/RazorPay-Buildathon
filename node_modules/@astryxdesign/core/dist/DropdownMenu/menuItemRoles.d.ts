 ...
 */
export declare const MENU_ITEM_ROLES: ReadonlySet<string>;
export declare const MENU_ITEM_SELECTOR: string;
/**
 ...
 */
export declare const MENU_BOUNDARY_SELECTOR = "[role=\"menu\"]";
//# sourceMappingURL=menuItemRoles.d.ts.map