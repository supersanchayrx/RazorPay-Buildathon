 ...
 * ```
 */
export declare function GridSpan({ columns, rows, xstyle, className, style, children, ref, ...props }: GridSpanProps): import("react").JSX.Element;
export declare namespace GridSpan {
    var displayName: string;
}
//# sourceMappingURL=GridSpan.d.ts.map