...
import type { StackCrossAlignment, StackMainAlignment } from '../Stack/stack.stylex';
 ...
 * ```
 */
export declare function HStack({ ref, justify, align, hAlign, vAlign, ...props }: HStackProps): import("react").JSX.Element;
