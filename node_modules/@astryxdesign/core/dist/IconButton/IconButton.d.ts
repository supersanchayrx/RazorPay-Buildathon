 ...
 */
export interface IconButtonProps extends Omit<ButtonProps, 'isIconOnly' | 'children' | 'endContent'> {
 ...
 * ```
 */
export declare function IconButton({ icon, ...props }: IconButtonProps): ReactNode;
