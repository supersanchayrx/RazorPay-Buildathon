 ...
 * ```
 */
export declare function InputGroupText({ ref, children, xstyle, className, style, ...rest }: InputGroupTextProps): React.JSX.Element;
export declare namespace InputGroupText {
