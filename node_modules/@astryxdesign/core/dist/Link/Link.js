  ...
  if (renderAsButton) {
    linkElement = /*#__PURE__*/_jsx("button", {
      ...
      ...mergeProps(themeProps('link', {
        color
      }), focusOutlineProps.focusVisible(styles.base, styles.buttonReset, linkColorStyles[color], hasUnderline && styles.hasUnderline, isStandalone && styles.standalone, isDisabled && styles.disabled, xstyle), className, style),
      ...props,
    ...
    linkElement = /*#__PURE__*/_jsx("a", {
      ...
      ...mergeProps(themeProps('link', {
        color
      }), focusOutlineProps.focusVisible(styles.base, linkColorStyles[color], hasUnderline && styles.hasUnderline, isStandalone && styles.standalone, styles.disabled, xstyle), className, style),
      ...props,
      children: sharedContent
    });
  } else {
