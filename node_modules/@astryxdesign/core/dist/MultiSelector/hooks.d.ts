 ...
 */
export declare function useMultiCombobox({ selectableItems, isDisabled, isOpen, hasSearch, onOpen, onClose, onToggle, onClear, hasValue, wasJustDismissed, listboxId, }: UseMultiComboboxOptions): UseMultiComboboxResult;
export {};
