...
import { type NavHeadingMenuSize } from './NavMenuContext';
 ...
 * ```
 */
export declare function NavHeadingMenu({ ref, children, size, minWidth, xstyle, className, style: styleProp, 'data-testid': testId, onKeyDown: onKeyDownProp, ...rest }: NavHeadingMenuProps): React.JSX.Element;
export declare namespace NavHeadingMenu {
    var displayName: string;
}
//# sourceMappingURL=NavHeadingMenu.d.ts.map