...
import { colorVars, spacingVars, typographyVars, typeScaleVars, radiusVars } from "../theme/tokens.stylex.js";
...
const styles = {
  root: {
    ...
    kGuDYH: "xcr08ib",
    kMwMTN: "x1tgivj0",
    kWkggS: "xjbqb8w x1c52tdz xoevpu5",
  ...
  return /*#__PURE__*/_jsxs(Element, {
    ...
    children: [icon && renderIconSlot(icon, {
      ...
      children: [typeof label === 'string' ? /*#__PURE__*/_jsx(Text, {
        ...
        maxLines: 1,
        children: label
      }) : label, description && /*#__PURE__*/_jsx(Text, {
        type: "supporting",
        maxLines: 1,
