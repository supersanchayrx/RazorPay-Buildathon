 ...
 * ```
 */
export declare function OverflowList({ children, gap, minVisibleItems, maxVisibleItems, maxRows, collapseFrom, behavior, overflowRenderer, onOverflowChange, xstyle, className, style, ref, ...props }: OverflowListProps): import("react").JSX.Element;
