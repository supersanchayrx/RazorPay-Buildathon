...
import { resolveNumberInputCommit } from "../NumberInput/numberInputCommit.js";
...
function useNumberEditorHandlers({
  ...
  const toFilterValue = useCallback(value => valueType === 'integer' ? {
    type: 'integer',
    value
  } : {
    type: 'float',
  ...
  const handleInput = useCallback(event => {
    pendingDecisionRef.current = resolveNumberInputCommit(event.currentTarget.value, {
      min,
      max,
      isIntegerOnly,
      locale,
