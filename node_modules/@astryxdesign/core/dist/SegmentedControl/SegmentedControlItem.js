...
export function SegmentedControlItem({
  ...
  return /*#__PURE__*/_jsxs("button", {
    ...
    }), focusOutlineProps.focusVisible(styles.base, sizeStyles[size], isFill && styles.fill, isSelected && styles.selected, !isSelected && !isItemDisabled && styles.hover, isItemDisabled && styles.disabled, xstyle)),
