...
import { parseNumberInput, resolveNumberInputCommit } from "../../../NumberInput/numberInputCommit.js";
...
function TextFilterControl({
  ...
  return /*#__PURE__*/_jsx(TextInput, {
    label: t('@astryx.tableFiltering.filterByColumn', {
      header
    }),
    isLabelHidden: true,
    value: strValue,
    ...
    placeholder: t('@astryx.tableFiltering.filterByColumn', {
      header
    }),
    size: size,
    hasClear: hasClear
...
function useLiveNumberFilter({
  ...
  const restoreRejectedDraft = useCallback(input => {
...
function PopoverFilterTrigger({
  ...
  return /*#__PURE__*/_jsx(Popover, {
    ...
    children: /*#__PURE__*/_jsx("button", {
      type: "button",
      "aria-label": t('@astryx.tableFiltering.filterByColumn', {
        header
      }),
      "aria-haspopup": "dialog",
      ...{
        0: {
          className: "x1ypdohk x16khyan x3nfvp2 x6s0dn4 xl56j7k x1717udv xh6dtrn x2lah0s x1xrq5m x17aqpur x3onkmb xof6bs x25t5g8"
        },
        1: {
          className: "x1ypdohk x16khyan x3nfvp2 x6s0dn4 xl56j7k x1717udv xh6dtrn x2lah0s x1xrq5m x17aqpur x1hc1fzr"
        }
      }[!!hasValue << 0],
