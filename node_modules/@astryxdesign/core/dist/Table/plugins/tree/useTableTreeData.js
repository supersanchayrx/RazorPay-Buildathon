...
function TreeExpander({
  ...
  return /*#__PURE__*/_jsx("button", {
    type: "button",
    ...{
      className: "x3nfvp2 x6s0dn4 xl56j7k xvy4d1p xxk0z11 xx3sua9 x1ypdohk x16khyan xv9yike x1gbuem2 xx6bhzk x1717udv x2lah0s xmvprkv xy5bzlh"
    },
    onClick: e => {
      e.stopPropagation();
      onToggle();
...
function TreeExpandAllToggle({
  ...
  return /*#__PURE__*/_jsx("button", {
    ...
    children: /*#__PURE__*/_jsx(Icon, {
      ...
      ,
      xstyle: [treeStyles.chevronIcon, allExpanded ? treeStyles.chevronIconExpanded : treeStyles.chevronIconCollapsed]
    })
  });
}
  ...
  return useMemo(() => {
    ...
    return {
      ...
      transformBodyRow(props, item) {
        ...
        const cfg = store.getConfig();
        const rowClickExpandable = cfg.hasRowClickExpansion === true && cfg.hasExpandableRows && cfg.getRowMeta(item)?.hasChildren === true;
        ...
        return {
          ...
          htmlProps: {
            ...
            onClick: event => {
              ...
              if (target.closest('button, a, input, select, textarea, [role="button"], [role="checkbox"], [contenteditable="true"]')) {
                return;
              }
