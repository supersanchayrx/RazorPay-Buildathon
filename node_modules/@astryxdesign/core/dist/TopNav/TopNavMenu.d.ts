 ...
 * ```
 */
export declare function TopNavMenu({ ref, label, items, delay, hideDelay, xstyle, className, style, onClick: onClickProp, onMouseEnter: onMouseEnterProp, onMouseLeave: onMouseLeaveProp, ...rest }: TopNavMenuProps): React.JSX.Element | null;
