 ...
 * ```
 */
export declare function TreeList({ items, density, variant, header, xstyle, className, style, 'data-testid': testId, 'aria-label': ariaLabel, 'aria-labelledby': ariaLabelledby, ref, ...restProps }: TreeListProps): import("react").JSX.Element;
