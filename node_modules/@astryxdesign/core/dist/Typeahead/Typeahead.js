...
export function Typeahead({
  ...
  const typeaheadContent = /*#__PURE__*/_jsxs(_Fragment, {
    children: [/*#__PURE__*/_jsxs("div", {
      ref: useMergedRefs(wrapperRef, disabledMessageTooltip.ref, inputGroup ? ref : undefined),
      "data-testid": testId,
      ...
      ...mergeProps(themeProps('typeahead', {
        size,
        status: status?.type
      }), stylex.props(inputWrapperStyles.base, styles.wrapper, sizeStyle, status && inputStatusBorderStyles[status.type], status && !isDisabled && inputStatusHoverShadowStyles[status.type], status && inputStatusFocusWithinStyles[status.type], isDisabled && inputWrapperStyles.disabled, inputGroup && groupStyles.inGroup, inputGroup && xstyle), inputGroup ? className : undefined, inputGroup ? style : undefined),
