 ...
 * ```
 */
export declare function TypeaheadItem<T extends SearchableItem>({ ref, item, icon, description, isDisabled, group: _group, xstyle, className, style, ...rest }: TypeaheadItemProps<T>): React.JSX.Element;
