 ...
 */
export declare const derivedVarRegistry: Record<string, DerivedVarEntry[]>;
/**
 ...
 */
export declare function getDerivedVars(component: string, property: string): DerivedVarEntry[];
//# sourceMappingURL=derivedVarRegistry.d.ts.map