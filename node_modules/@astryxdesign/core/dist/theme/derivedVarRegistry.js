 ...
 */
const DEPRECATED_REGISTRY_KEYS = {
 ...
 */
export function getDerivedVars(component, property) {
  const renamedTo = DEPRECATED_REGISTRY_KEYS[component];
  const entries = derivedVarRegistry[component] ?? (renamedTo ? derivedVarRegistry[renamedTo] : undefined);
  if (!entries) {
    return [];
  }
