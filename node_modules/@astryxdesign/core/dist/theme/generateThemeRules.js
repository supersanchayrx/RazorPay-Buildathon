 ...
 * byte-identical.
 */
export function generateDataTokenDefaultsCSS() {
  const declarations = Object.entries(dataTokenDefaults).map(([prop, value]) => `  ${prop}: ${value};`).join('\n');
  return `:root {\n${declarations}\n}`;
}
