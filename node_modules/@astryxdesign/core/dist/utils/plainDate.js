 ...
 */
export function plainDateDiffDays(a, b) {
 ...
 * formatting.
 */
export function getTimeZoneParts(instant, timezoneID) {
...
export const DATE_FORMAT_SHORT_WITH_WEEKDAY = {
  weekday: 'short',
  month: 'short',
  day: 'numeric',
  year: 'numeric'
 ...
 */
export function plainDateFormat(pd, options, locale = 'en') {
 ...
 */
export const SHARED_DATE_FORMAT_OPTIONS = {
 ...
 */
export function formatSharedDate(pd, format, locale = 'en') {
